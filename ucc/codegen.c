...
void
gen_code(enum op_codes op_code, int arg)
{
    section_code[code_offset].op = op_code;
    section_code[code_offset++].arg = arg;
}

void
back_patch(int addr, enum op_codes op_code, int arg)
{
    section_code[addr].op = op_code;
